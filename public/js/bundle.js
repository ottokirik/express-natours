...
exports.showAlert = exports.hideAlert = exports.ERROR = exports.SUCCESS = void 0;
var SUCCESS = 'success';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === _alerts.SUCCESS) {
              (0, _alerts.showAlert)(_alerts.SUCCESS, 'Logged in successfully');
          ...
          case 7:
            ...
            (0, _alerts.showAlert)(_alerts.ERROR, _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === _alerts.SUCCESS) {
              (0, _alerts.showAlert)(_alerts.SUCCESS, 'Logged out successfully');
          ...
          case 7:
            ...
            (0, _alerts.showAlert)(_alerts.ERROR, 'Error logging out. Try again.');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGV0cm92aWNoMDEwMyIsImEiOiJjazhhNGhtc2owY3ZhM2VvZm41azh6dHRkIn0.tvJjaOQa0lQVXy5gqN1Lhg';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // eslint-disable-next-line no-new
...
exports.updateSettings = exports.UPDATE_DATA = exports.UPDATE_PASSWORD = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(type === UPDATE_DATA ? 'update-me' : 'update-password'),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === _alerts.SUCCESS) {
              (0, _alerts.showAlert)(_alerts.SUCCESS, 'Your settings was updated.');
            }
...
/* eslint-disable */
var stripe = Stripe('pk_test_QoMAtixmjD2vUjpqK6988AGP');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              }, _updateSettings.UPDATE_PASSWORD);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "37203" + '/');
